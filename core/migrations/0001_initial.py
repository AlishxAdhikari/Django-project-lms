# Generated by Django 5.2.3 on 2025-06-15 08:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.CharField(blank=True, choices=[('BEI', 'Bachelor of Electronics and Information'), ('BCA', 'Bachelor of Computer Application'), ('BCE', 'Bachelor of Civil Engineering'), ('BCT', 'Bachelor of Computer Engineering')], default='N/A', max_length=20, null=True)),
                ('phone_no', models.IntegerField()),
